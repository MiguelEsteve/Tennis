...
class Formatter(logging.Formatter):
    ...
    tst_fmt = "\033[1;36mTEST: %(module)s: %(funcName)s: %(lineno)d: %(msg)s\033[0m"
    ...
    def format(self, record):
        ...
        elif record.levelno == TEST_LEVEL:
            self._style._fmt = Formatter.tst_fmt
...
LOGGING = {
    ...
    'loggers': {
        ...
        'tests.vision.flownet.test_flownet2s': {
            'handlers': ['console'],
            'level': 'DEBUG'
        }
    }
